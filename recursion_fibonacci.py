...
# I accomplished my goal and then expanded the project in a few ways:
# I created a function to find the sum up to a given element in the sequence
# and then I created two new functions to find the sum much faster
# than the recursive way.

# Method 1: Recursive
# Fibonacci seq generated by fib_recursive()
# addition done by fib_sum_if(). Not sure why I called it that.

# Method 2: List
# Fibonacci seq generated by fib_list().
# Addition done by fib_sum_list().
